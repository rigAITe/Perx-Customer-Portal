...
function FourCols( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>Porto React Ecommerce - Category Four Cols</title>
            </Helmet>
            ...
            <div className="main">
                ...
                <Breadcrumb current="Four Cols" path="categories" />
...
export default connect( mapStateToProps, {} )( FourCols );