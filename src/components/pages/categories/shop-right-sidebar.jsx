...
function RightSidebar( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>Porto React Ecommerce - Category Right Sidebar</title>
            </Helmet>
            ...
            <div className="main">
                ...
                <Breadcrumb current="Sidebar Right" path="categories" />
                <div className="container">
                    <div className="row">
                        ...
                        <SidebarToggle />
                        <aside className="sidebar-shop col-lg-3 mobile-sidebar">
                            <ShopSidebar />
                        </aside>
                    </div>
                </div>
