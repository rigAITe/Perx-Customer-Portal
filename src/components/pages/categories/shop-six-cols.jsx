...
function SixCols( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>Porto React Ecommerce - Category Six Cols</title>
            </Helmet>
            ...
            <div className="main">
                ...
                <Breadcrumb current="Six Cols" path="categories" />
                <div className="container skeleton-body skel-shop-products">
                    ...
                    <SidebarToggle />
                    <aside className="sidebar-shop mobile-sidebar d-lg-none">
                        <ShopSidebar />
                    </aside>
                </div>
...
export default connect( mapStateToProps, {} )( SixCols );