...
import ShopProducts from "./shop-grid-product.jsx";
import ToolBox from "./tool-box.jsx";
import Pagination from "../../../../../../../src/components/features/pagination.jsx";
import { setParallax } from "../../../../../../utils";

function RedeemProducts( props ) {
    ...
    return (
      <>
        ...
        <h1 className="d-none">Customer Portal - Auction Page</h1>
...
export default connect(mapStateToProps, {})(RedeemProducts);