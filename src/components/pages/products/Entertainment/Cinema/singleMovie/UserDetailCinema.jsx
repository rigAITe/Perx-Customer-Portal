      ...
      <form style={{ marginBottom: 0 }} onSubmit={postData}>
        <div className='card-bodie'>
          <div className='row space-around'>
            <div>
              <p><b>Cinema:</b> {props.cinema}</p>
              <p><b>Ticket Type:</b> {props.info.type}</p>
            </div>
            <div >
              <p><b>Time:</b> {props.time}</p>
              <p><b>Quantity:</b> {props.info.quantity}</p>
            </div>
            <div >
              <p><b>Points:</b> {props.info.points}</p>
            </div>
          </div>
          <div className='row'>
...
export default UserDetailCinema
