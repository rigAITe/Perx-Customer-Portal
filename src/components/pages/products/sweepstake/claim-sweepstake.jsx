...
// import FeaturedProductsOne from '../products/common/product-groups/featured-products-one';

function ClaimSweepstake( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>
                    Customer Portal -  Claim Sweepstake 
                    {/* {props.productId} */}
                </title>
            </Helmet>

            <h1 className="d-none">Customer Portal - Claim Sweepstake 
                    {/* {props.productId} */}
                    </h1>
...
export default connect( mapStateToProps, {} )( ClaimSweepstake );